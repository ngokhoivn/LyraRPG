...
#include "Camera/RPGCameraTypes.h"
 ...
 *
 *	A basic third person camera mode for the RPG plugin.
 *  Standalone version of LyraCameraMode_ThirdPerson.
 */
UCLASS(Abstract, Blueprintable)
class RPGRUNTIME_API URPGCameraMode_ThirdPerson : public URPGCameraMode
{
	GENERATED_BODY()
