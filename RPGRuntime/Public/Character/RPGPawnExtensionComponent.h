 ...
 * Standalone version of LyraPawnExtensionComponent.
 */
UCLASS()
class RPGRUNTIME_API URPGPawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()
...
public:
	...
	void InitializeAbilitySystem(URPGAbilitySystemComponent* InASC, AActor* InOwnerActor);
...
protected:
	...
	UPROPERTY(EditInstanceOnly, ReplicatedUsing = OnRep_PawnData, Category = "RPG|Pawn")
