 ...
 * ARPGWorldSettings
 *
 * The default world settings object for the RPG plugin.
 * Used primarily to set the default gameplay experience to use when playing on this map.
 */
UCLASS()
class RPGRUNTIME_API ARPGWorldSettings : public AWorldSettings
{
	GENERATED_BODY()

public:

	ARPGWorldSettings(const FObjectInitializer& ObjectInitializer);
